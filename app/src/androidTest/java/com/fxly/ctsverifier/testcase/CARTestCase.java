...
public class CARTestCase {
    ...
    @Test
    public void Car_Dock_test() {
        Action.UiTextScrollable("Car Dock Test");
        Action.NoticeConfirm("Car Dock Test");
        Action.UiTextSelector("Enable Car Mode");
        Action.UiTextSelector("CTS Verifier");
        Action.UiTextSelector("Always");
        mDevice.pressHome();
    }
